...
export const defaultConnectors: ConnectorConfig[] = [
  ...
  },
  {
    ...
    icon: 'Zap',
    status: 'disconnected',
    endpoint: 'eventgrid.azure.net/topics/iot-fleet',
    protocol: 'MQTT / HTTPS',
    devicesDiscovered: 0,
    color: '#4CAF50',
  },
  {
    ...
    icon: 'Cpu',
    status: 'disconnected',
    endpoint: 'sdk://trustedge-light.local:8443',
    protocol: 'TrustEdge Light Protocol',
    devicesDiscovered: 0,
    color: '#742EAA',
    isNew: true,
  },
...
export const simulatedDiscoveryDevices: DiscoveredDevice[] = [
  ...
  // Azure Event Grid — industrial devices
  { id: 'eg-01', connectorId: 'azure-eventgrid', ipAddress: '10.2.0.100', hostname: 'plc-line1-main', deviceType: 'PLC', manufacturer: 'Siemens', firmwareVersion: '4.5.2', currentAlgorithm: 'RSA-1024', keySize: 1024, industry: 'industrial', deviceClass: 'constrained' },
  { id: 'eg-02', connectorId: 'azure-eventgrid', ipAddress: '10.2.0.101', hostname: 'plc-line2-aux', deviceType: 'PLC', manufacturer: 'Allen-Bradley', firmwareVersion: '33.011', currentAlgorithm: 'RSA-1024', keySize: 1024, industry: 'industrial', deviceClass: 'constrained' },
  { id: 'eg-03', connectorId: 'azure-eventgrid', ipAddress: '10.2.0.110', hostname: 'gateway-north', deviceType: 'IoT Gateway', manufacturer: 'Schneider Electric', firmwareVersion: '6.0.8', currentAlgorithm: 'RSA-2048', keySize: 2048, industry: 'industrial', deviceClass: 'mid-range' },
  { id: 'eg-04', connectorId: 'azure-eventgrid', ipAddress: '10.2.0.115', hostname: 'hmi-panel-ctrl', deviceType: 'HMI Panel', manufacturer: 'ABB', firmwareVersion: '5.2.0', currentAlgorithm: 'RSA-2048', keySize: 2048, industry: 'industrial', deviceClass: 'mid-range' },
  { id: 'eg-05', connectorId: 'azure-eventgrid', ipAddress: '10.2.0.120', hostname: 'vibration-mon-01', deviceType: 'Vibration Sensor', manufacturer: 'Emerson', firmwareVersion: '2.3.1', currentAlgorithm: 'AES-128-PSK', keySize: 128, industry: 'industrial', deviceClass: 'constrained' },
  { id: 'eg-06', connectorId: 'azure-eventgrid', ipAddress: '10.2.0.125', hostname: 'flow-meter-tank2', deviceType: 'Flow Meter', manufacturer: 'Endress+Hauser', firmwareVersion: '3.0.7', currentAlgorithm: 'AES-128-PSK', keySize: 128, industry: 'industrial', deviceClass: 'constrained' },

  // TrustEdge Light — brownfield & constrained devices
  { id: 'tc-01', connectorId: 'trustcore-sdk', ipAddress: '10.3.0.10', hostname: 'sensor-node-01', deviceType: 'Sensor Node', manufacturer: 'Nordic Semi', firmwareVersion: '2.4.0', currentAlgorithm: 'ECDSA-P256', keySize: 256, industry: 'industrial', deviceClass: 'constrained' },
  { id: 'tc-02', connectorId: 'trustcore-sdk', ipAddress: '10.3.0.11', hostname: 'field-gateway-02', deviceType: 'Field Gateway', manufacturer: 'Advantech', firmwareVersion: '4.8.2', currentAlgorithm: 'ECDSA-P256', keySize: 256, industry: 'industrial', deviceClass: 'mid-range' },
  { id: 'tc-03', connectorId: 'trustcore-sdk', ipAddress: '10.3.0.12', hostname: 'env-monitor-03', deviceType: 'Environment Monitor', manufacturer: 'Bosch', firmwareVersion: '2.3.0', currentAlgorithm: 'AES-128-PSK', keySize: 128, industry: 'smart-home', deviceClass: 'constrained' },
  { id: 'tc-04', connectorId: 'trustcore-sdk', ipAddress: '10.3.0.13', hostname: 'edge-relay-04', deviceType: 'Edge Relay', manufacturer: 'Cisco', firmwareVersion: '5.1.0', currentAlgorithm: 'ECDSA-P256', keySize: 256, industry: 'enterprise', deviceClass: 'mid-range' },
  { id: 'tc-05', connectorId: 'trustcore-sdk', ipAddress: '10.3.0.14', hostname: 'actuator-ctrl-05', deviceType: 'Actuator Controller', manufacturer: 'Honeywell', firmwareVersion: '1.9.0', currentAlgorithm: 'AES-128-PSK', keySize: 128, industry: 'industrial', deviceClass: 'constrained' },
  { id: 'tc-06', connectorId: 'trustcore-sdk', ipAddress: '10.3.0.15', hostname: 'smart-meter-06', deviceType: 'Smart Meter', manufacturer: 'Itron', firmwareVersion: '3.1.2', currentAlgorithm: 'ECDSA-P256', keySize: 256, industry: 'enterprise', deviceClass: 'constrained' },
  { id: 'tc-07', connectorId: 'trustcore-sdk', ipAddress: '10.3.0.16', hostname: 'data-logger-07', deviceType: 'Data Logger', manufacturer: 'Digi International', firmwareVersion: '2.5.1', currentAlgorithm: 'ECDSA-P384', keySize: 384, industry: 'industrial', deviceClass: 'mid-range' },
